...
export interface SampleERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface SampleERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): SampleERC721;
  waitForDeployment(): Promise<this>;

  interface: SampleERC721Interface;
